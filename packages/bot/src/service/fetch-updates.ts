...
export class BotFetchUpdatesService extends Context.Reference<BotFetchUpdatesService>()(
...
export class FetchUpdatesError extends Data.TaggedError("FetchUpdatesError")<{
...
const _fetchUpdates = (pollState: State) =>
  Micro.gen(function* () {
    ...
    if (
      ...
      pollState.emptyResponses == pollSettings.max_empty_responses
    ) {
...
const _commitLastBatch = (pollState: State) =>
  Micro.gen(function* () {
