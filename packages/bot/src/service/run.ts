...
export class BotRunService extends Context.Reference<BotRunService>()(
  "BotRunService",
  {
    defaultValue: () => {
...
const _runBotDaemon = (state: State) =>
  Micro.gen(function* () {
